...
<%  
	...
	if (user!=null) {
		...
		//mauricio aqui devia ter uma entidade s� e colocar uma coluna como argumento do q ele votou 
		//imagina q agnt est� fazendo dois acessos ao banco quando s� precisava fazer um 
...
%> 
	<div class="row"style="margin-left:0;">
		<% //if se o usuario n�o votou em alguma coisa  
